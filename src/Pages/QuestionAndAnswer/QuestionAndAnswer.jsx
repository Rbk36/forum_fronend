...
//     e.preventDefault();
//     const prompt = aiPromptInput.current.value;
//     if (!prompt) {
//       Swal.fire({
//         title: "Error",
...
//     }
//     try {
//       const response = await axiosInstance.post("/answers/ai", {
//         questionid: questionId,
//         prompt: prompt,
//       });
//       if (response.status === 201) {
//         Swal.fire({
//           title: "Success!",
//           text: "AI answer generated and posted!",
//           icon: "success",
//           confirmButtonText: "OK",
//         }).then(() => {
